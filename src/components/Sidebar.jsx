...
export default function Sidebar() {
  const { liveSession, creator, activeVideo, workspaceVideos, videosTotal, totalQuestions } = useAppState()
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-fixed-top">
        ...
        <div className="workspace-switcher"><span className="avatar avatar-purple">{initials}</span><span><strong>{displayName}</strong><small>Creator workspace</small></span><ChevronDown size={15} /></div>
